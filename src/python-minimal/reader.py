...
if __name__ == "__main__":
    ...
    assert datapoints1[-1] == {'freq': 'q',  'label': 'GDP_bln_rub',  'period': 4,  'value': '25503', 'year': '20172)'}
    assert datapoints1[0] == {'freq': 'a',  'label': 'GDP_bln_rub', 'period': 1, 'value': '4823', 'year': '1999'}    
...
1999	653,8	22,7	49,2	91,5	138,7	185,0	240,0	288,5	345,5	400,6	454,0	528,0"""    
    ...
    assert data[0] == {'freq': 'a', 'label': 'VARX_bln_rub', 'period': 1, 'value': '653,8', 'year': '1999'}
    assert data[-1] == {'freq': 'm', 'label': 'VARX_bln_rub', 'period': 11, 'value': '528,0', 'year': '1999'}
    f.unlink()
