    ...
    rows_dicts = [{'name': 'Объем ВВП',
                  ...
                  {'name': '1991 1)',
                   'data': ['4823',
                            ...
                            '1373',
                            '1447']},
                  {'name': '1.2. Индекс промышленного производства1) / Industrial Production index1)',
                   'data': []},
...
# RowStack() -> Tables
# FIXME: test functions like split_to_tables(),
# parse.get_tables_from_rows_segment(rows, _pdef(), _units())
...
class Test_Table():
    ...
    def test_Table_instance_datarows(self, table):
        ...
        assert table.datarows[0].data == [
            "4823", "901", "1102", "1373", "1447"]
...
def test_datapoints(datapoints):
    ...
    # ind_prod {'name': '2015', 'data': ['99,2', '99,9', '98,3', '99,5',
    # '99,1', '100,0', '98,2', '101,2', '98,2', '97,6', '99,1', '98,5',
    # '100,2', '99,7', '98,4', '101,0', '98,1']}]
