...
assert int(InterimDataLocation().max_year()) >= 2017
mm = int(InterimDataLocation().max_month())
assert mm <= 12 
assert mm >= 1 

def loc(year, month, root, prefix=PREFIX):
...
# MAYDO: non-csv output directory locations
