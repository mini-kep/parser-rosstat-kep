...
function called 1 times
   ...
   ncalls  tottime  percall  cumtime  percall filename:lineno(function)
      ...
      108    0.003    0.000    4.775    0.044 session.py:28(get_parsed_tables)
   ...
   667459    0.244    0.000    1.322    0.000 re.py:179(search)
      324    0.001    0.000    1.107    0.003 worker.py:190(wrapper)
      324    0.001    0.000    1.100    0.003 worker.py:175(get_parsed_tables)
   667459    0.783    0.000    0.842    0.000 re.py:286(_compile)
      324    0.000    0.000    0.814    0.003 worker.py:32(__init__)
      324    0.105    0.000    0.814    0.003 worker.py:95(parse_units)
   196572    0.572    0.000    0.622    0.000 units.py:14(extract)
     2160    0.002    0.000    0.271    0.000 worker.py:42(apply)
      216    0.015    0.000    0.248    0.001 worker.py:53(start_with)
